...
products[4][1] = {}
products[4][1][0] = {}
products[4][1][0][0] = "奧斯陸"
products[4][1][0][1] = Location(1886, 388)
products[4][1][1] = {}
products[4][1][1][0] = "維斯比"
products[4][1][1][1] = Location(2034, 388)
products[5] = {}
products[5][0] = "石像.png"
products[5][1] = {}
products[5][1][0] = {}
products[5][1][0][0] = "卑爾根"
products[5][1][0][1] = Location(1886, 388)
products[5][1][1] = {}
products[5][1][1][0] = "奧斯陸"
products[5][1][1][1] = Location(2034, 388)
...
while true do
    ...
    -- 指定生產港
    click(products[productIndex][1][productPlace][1])

    if productPlace == 0 then
        productPlace = 1
    else
        productPlace = 0
    end
