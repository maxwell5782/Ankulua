...
while true do
  ...
  if Region(448, 132, 67, 21):exists("master.png", 10) then
    ...
    manualTouch({
      ...
      { action = "touchDown", target = Location(400, 100) },
      { action = "touchMove", target = Location(700, 100) },
      { action = "touchUp",   target = Location(700, 100) },
      { action = "wait",      target = 1 },
      { action = "touchDown", target = Location(565, 185) },
      { action = "touchUp",   target = Location(565, 185) } })
  end
  ...
  manualTouch({
    { action = "wait",      target = 1 },
    { action = "touchDown", target = Location(464, 325) },
    { action = "touchUp",   target = Location(464, 325) },
    { action = "wait",      target = 1 },
